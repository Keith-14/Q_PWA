...
import { Menu, Bell, MapPin, ChevronDown, Sun, Sunrise, Sunset, Moon, Cloud, CloudSun, Sparkles, Package } from 'lucide-react';
...
const essentials = [
  { label: 'Hadith', img: hadithIcon, icon: null, path: '/hadith' },
