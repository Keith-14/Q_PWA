...
export const IslamicNewsCard = () => {
  ...
  return (
    <Card className="relative overflow-hidden glass-dark p-5 shine-effect">
      ...
      <div className="absolute top-0 right-0 w-32 h-32 bg-[radial-gradient(circle_at_top_right,hsl(145_70%_45%/0.08),transparent_60%)] pointer-events-none" />
      
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-4">
          <div className="p-2.5 rounded-xl bg-gradient-to-br from-primary/20 to-primary/8 border border-primary/20 shadow-[0_0_12px_-3px_hsl(145_70%_45%/0.25)]">
            <Newspaper className="h-4 w-4 text-primary" strokeWidth={1.5} />
          </div>
          <h2 className="text-sm font-bold text-emerald-gradient flex items-center gap-2">
            Islamic World News
